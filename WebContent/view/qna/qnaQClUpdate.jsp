	...
	<section id="writeForm">
		...
		<form
			...
			<section id="commandCell">
				<a href="javascript:modifyboard()" class="btn btn-default" title="수정완료 버튼" alt="수정완료 버튼">수정</a>&nbsp;&nbsp;
				<a
					href="qnaQClDetail.qn?QNUM=<%=article.getQNUM()%>&page=<%=nowPage%>" class="btn btn-default"
