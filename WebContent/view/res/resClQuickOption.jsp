...
<div class="container">
<form class="form-horizontal" role="form" action="/mycar/resClQuickPro.re" method="post" id="resClQOption" name="resClQOption" onsubmit="return empty()">
...
<div class="form-group" style="text-align: center; margin: auto;">
<button type="button" class="btn btn-default" id="back" name="back" style="background-color: #1e1a1b; color: #fff;" title="홈으로 돌아가기" onClick="location.href='/mycar'">홈으로</button>&nbsp;&nbsp;&nbsp;
<button type="submit" class="btn btn-default" style="background-color: #1e1a1b; color: #fff;" title="다음 페이지로 넘어가기">다음</button>
</div>
<br/>
</form>
</div>
