...
public class QnaQAdListAction implements Action {
	 ...
	 public ActionForward execute(HttpServletRequest request,HttpServletResponse response) throws Exception{
			...
			int listCount = qnaqClListService.getListCount(); //총 리스트 수를 받아옴.
			articleList = qnaqClListService.getArticleList(page,limit); //리스트를 받아옴.
			//총 페이지 수.
			...
			request.setAttribute("articleList", articleList);	
	   		forward.setPath("/view/qna/qnaQAdList.jsp");
			}
	   		return forward;   		
		 }
}
